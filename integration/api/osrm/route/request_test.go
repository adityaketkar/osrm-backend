	...
	cases := []struct {
		...
		},
		{
			Request{
				...
				Approaches:       osrm.OptionElements{},
				Exclude:          osrm.OptionClasses{},
				Alternatives:     OptionAlternativesValueTrue,
				Steps:            OptionStepsDefaultValue,
				Annotations:      OptionAnnotationsDefaultValue,
				Geometries:       OptionGeometriesDefaultValue,
				Overview:         OptionOverviewDefaultValue,
		...
		},
		{
			Request{
				...
				Steps:            OptionStepsDefaultValue,
				Annotations:      OptionAnnotationsDefaultValue,
				Geometries:       OptionGeometriesValuePolyline6,
				Overview:         OptionOverviewDefaultValue,
				ContinueStraight: OptionContinueStraightDefaultValue,
			},
		...
		},
		{
			Request{
				...
				Annotations:      OptionAnnotationsDefaultValue,
				Geometries:       OptionGeometriesDefaultValue,
				Overview:         OptionOverviewValueFull,
				ContinueStraight: OptionContinueStraightDefaultValue,
			},
		...
		},
		{
			Request{
				...
				Geometries:       OptionGeometriesDefaultValue,
				Overview:         OptionOverviewDefaultValue,
				ContinueStraight: OptionContinueStraightValueFalse,
			},
		...
		},
		{
			Request{
				...
				Overview:         OptionOverviewDefaultValue,
				ContinueStraight: OptionContinueStraightDefaultValue,
				Waypoints:        osrm.CoordinateIndexes{0, 3, 5},
			},
		...
		},
		{
			Request{
				...
				Profile:          "driving",
				Coordinates:      osrm.Coordinates{osrm.Coordinate{Lat: 37.364336, Lon: -122.006349}, osrm.Coordinate{Lat: 37.313767, Lon: -121.875654}},
				Bearings:         osrm.OptionElements{"0,0", "120,180", "360,150"},
				Radiuses:         osrm.OptionElements{},
				GenerateHints:    osrm.OptionGenerateHintsDefaultValue,
				Hints:            osrm.OptionElements{},
				Approaches:       osrm.OptionElements{},
		...
		},
		{
			Request{
				...
				Coordinates:      osrm.Coordinates{osrm.Coordinate{Lat: 37.364336, Lon: -122.006349}, osrm.Coordinate{Lat: 37.313767, Lon: -121.875654}},
				Bearings:         osrm.OptionElements{},
				Radiuses:         osrm.OptionElements{"1.2", "0.6", "1000.1", "unlimited"},
				GenerateHints:    osrm.OptionGenerateHintsDefaultValue,
				Hints:            osrm.OptionElements{},
				Approaches:       osrm.OptionElements{},
				Exclude:          osrm.OptionClasses{},
		...
		},
		{
			Request{
				...
				Radiuses:         osrm.OptionElements{},
				GenerateHints:    osrm.OptionGenerateHintsDefaultValue,
				Hints:            osrm.OptionElements{"LZ42gzaeNoMwAAAABwAAAAkAAAB3AAAAIccvQp1vtUDjiPpAQ9TUQjAAAAAHAAAACQAAAHcAAAC1VgAArlS6-DEjOgKzVLr4cCI6AgEAjwXzVESk", "NoM5g0CDOYMAAAAAKgAAAAAAAAApAAAAAAAAAJ_1F0IAAAAAkhEUQgAAAAAqAAAAAAAAACkAAAC1VgAA-FK8-GZeOQI6U7z451w5AgAA7wLzVESk"},
				Approaches:       osrm.OptionElements{},
				Exclude:          osrm.OptionClasses{},
				Alternatives:     OptionAlternativesDefaultValue,
				Steps:            OptionStepsDefaultValue,
		...
		},
		{
			Request{
				...
				GenerateHints:    osrm.OptionGenerateHintsDefaultValue,
				Hints:            osrm.OptionElements{},
				Approaches:       osrm.OptionElements{"curb", "curb", "unrestricted"},
				Exclude:          osrm.OptionClasses{},
				Alternatives:     OptionAlternativesDefaultValue,
				Steps:            OptionStepsDefaultValue,
				Annotations:      OptionAnnotationsDefaultValue,
		...
		},
		{
			Request{
				...
				Hints:            osrm.OptionElements{},
				Approaches:       osrm.OptionElements{},
				Exclude:          osrm.OptionClasses{"toll", "motoway", "ferry"},
				Alternatives:     OptionAlternativesDefaultValue,
				Steps:            OptionStepsDefaultValue,
				Annotations:      OptionAnnotationsDefaultValue,
				Geometries:       OptionGeometriesDefaultValue,
		...
		},
		{
			Request{
				...
				Alternatives:     "5",
				Steps:            true,
				Annotations:      OptionAnnotationsValueTrue,
				Geometries:       OptionGeometriesValueGeojson,
				Overview:         OptionOverviewValueFalse,
				ContinueStraight: OptionContinueStraightValueTrue,
				Waypoints:        osrm.CoordinateIndexes{2, 3},
			},
	...
	cases := []struct {
	...
	}{
		{
			...
			&Request{
				...
				Steps:            true,
				Annotations:      OptionAnnotationsValueTrue,
				Geometries:       OptionGeometriesValuePolyline,
				Overview:         OptionOverviewValueFalse,
				ContinueStraight: OptionContinueStraightValueTrue,
				Waypoints:        osrm.CoordinateIndexes{2, 4, 6},
			},
			false,
		},
		{
