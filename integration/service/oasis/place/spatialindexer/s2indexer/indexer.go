...
import (
	...
	"github.com/Telenav/osrm-backend/integration/service/oasis/place/spatialindexer/placeloader"
	"github.com/golang/geo/s2"
	"github.com/golang/glog"
)

type cellID2PointIDMap map[s2.CellID][]entity.PlaceID
type pointID2LocationMap map[entity.PlaceID]nav.Location
...
func (indexer *S2Indexer) FindNearByPlaceIDs(center nav.Location, radius float64, limitCount int) []*entity.PlaceWithLocation {
	...
	if limitCount != place.UnlimitedCount && len(results) > limitCount {
...
func (indexer S2Indexer) getPointLocationByPointID(id entity.PlaceID) (nav.Location, bool) {
	location, ok := indexer.pointID2Location[id]
	return location, ok
}

func (indexer S2Indexer) getPointIDsByS2CellID(cellid s2.CellID) ([]entity.PlaceID, bool) {
...
func elementID2PointID(id int64) entity.PlaceID {
	return (entity.PlaceID)(id)
}
