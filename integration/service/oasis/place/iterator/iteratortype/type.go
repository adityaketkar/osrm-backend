...
func (neighbor NeighborInfo) FromPlaceID() entity.PlaceID {
	return convertIDFromStringToPlaceID(neighbor.FromID)
}

// ToPlaceID converts from String to PlaceID for To
func (neighbor NeighborInfo) ToPlaceID() entity.PlaceID {
...
func convertIDFromStringToPlaceID(s string) entity.PlaceID {
	switch s {
...
func isPredefinedValueTakenPlaceIDValue(id entity.PlaceID) bool {
